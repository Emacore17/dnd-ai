...
- [ ] **Step 1: registrare l'avvio del task nello stesso batch funzionale**
...
- [ ] **Step 2: scrivere il primo contract test, limitato all'overview**
...
test("architecture overview represents every tracked workspace", async () => {
  ...
  for (const packageName of await workspacePackageNames()) {
    assert.match(overview, new RegExp(`\\`${escapeRegExp(packageName)}\\``, "u"));
  }
...
- [ ] **Step 4: creare ADR-0009 con la decisione completa**
...
- [ ] **Step 5: consolidare l'overview con viste separate**
...
- [ ] **Step 6: registrare ADR-0009 e verificare il batch**
...
- [ ] **Step 7: committare il primo deliverable**
...
- [ ] **Step 1: aggiungere i test dati e setup locale**
...
test("data model follows the persistence migration head", async () => {
  ...
  for (const tableName of [
    ...
    assert.match(dataModel, new RegExp(`\\`${escapeRegExp(tableName)}\\``, "u"));
  }
});
...
- [ ] **Step 2: verificare il failure path ENOENT**
...
- [ ] **Step 4: creare `LOCAL_DEVELOPMENT.md`**
...
- [ ] **Step 5: eseguire i gate del deliverable**
...
- [ ] **Step 6: committare il secondo deliverable**
...
- [ ] **Step 1: promuovere i documenti nell'indice**
...
- [ ] **Step 2: aggiornare contesto e tracciabilità**
...
- [ ] **Step 3: aggiornare changelog e metadata**
...
- [ ] **Step 4: verificare il sistema documentale completo**
...
- [ ] **Step 5: committare il terzo deliverable**
...
**Files:**
- No repository changes unless the verification reveals a functional finding.
