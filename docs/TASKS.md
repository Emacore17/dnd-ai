...
> **Task attivo:** `BL-006 — IN_PROGRESS/50%/PARTIAL` sulla branch `codex/bl-006-sessions-reset`; contract, schema, store e sei route API access/reset sono verdi; outbox reset è il prossimo batch
