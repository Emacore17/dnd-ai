...
> **Task attivo:** `BL-006 — IN_PROGRESS/75%/PARTIAL` sulla branch `codex/bl-006-sessions-reset`; runtime API e worker access/reset sono verdi; BFF e UI mobile sono il prossimo batch
