...
I task proprietari sono rispettivamente `BL-030`, `BL-029`, `BL-028`/`BL-038` e `BL-080`. Signup, verifica e sessione iniziale sono implementati e integrati da BL-005. BL-006 ha approvato il design di login, refresh, logout, revoca completa e reset, ma il relativo runtime non è ancora implementato. Lo stato bloccato di `BL-080` non autorizza deploy, release, Production o modifiche all'account Vercel.
...
| Migrazioni | PostgreSQL 17 + pgvector, ledger applicativo, head `000003_identity_signup`; target BL-006 `000004_identity_access` non implementato | [`DATABASE_MIGRATIONS.md`](../operations/DATABASE_MIGRATIONS.md), [`ADR-0006`](../adr/0006-postgresql-migration-foundation.md) |
