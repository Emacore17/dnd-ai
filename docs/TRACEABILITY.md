...
| Modello dati e migration head | spec §19; ADR-0006, ADR-0010 | DOC-ARCH-001, BL-005, BL-006 | `docs/data/DATA_MODEL.md`; `000003_identity_signup`; target `000004_identity_access` | architecture-documentation contract + migration contract/database/identity suite | head `000003` integrato e PostgreSQL reale PASS; target BL-006 `database-identity-access-v1` approvato, non implementato |
...
| Migration PostgreSQL riproducibili e versionate | spec §§19.5, 26.4, 29.5; ADR-0006 | BL-004, BL-010, BL-005, BL-006 | `packages/persistence`, `scripts/run-database-migrations.mjs`, `infra/local/postgres.compose.yml` | zero→head e previous→head, replay, source/contract drift, file sconosciuto pre-DDL, due runner simultanei, vincoli/indice, rollback/re-apply su PostgreSQL 17/pgvector 0.8.2 | head `000003` integrato/PASS; `000004_identity_access` e zero/previous→head restano gate BL-006 |
