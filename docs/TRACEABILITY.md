...
Il repository pubblico è versionato e collegato a `Emacore17/dnd-ai`. `BL-001` ha introdotto lo scaffold applicativo, `BL-002` pipeline/Ruleset e `BL-003` config/startup fail-fast. `BL-004`, `BL-005`, `BL-008`, `BL-009`, `BL-010`, `BL-079`, `GOV-002`, `GOV-004`, `QA-001` e `DOC-ARCH-001` sono `DONE/100%/PASSING` e integrati su `main`. BL-005 è verificato tramite PR #28, candidate corretto `c2e4332b408f1cac3e2c69920cd18e5e772e87bf`, merge `e173fd9424ad77330ae8302f68affd4832d66798` e CI PR/post-merge `29525777416`/`29526030389`, entrambe 5/5 `SUCCESS`. `BL-006` è `IN_PROGRESS/75%/PARTIAL`: design `identity-access-v1`, artifact `v3`, config/domain, primitive crypto, migration `000004`, store, API e worker access/reset sono implementati sulla branch; BFF/UI e gate terminali restano aperti. `BL-081` resta `READY`, `QA-002` `BACKLOG` e `BL-080` congelato/bloccato.
