...
| Login, session lifecycle, logout, revoca globale e reset one-time | spec §§20, 22.2, 22.8–22.12, 26.5, 26.8, 26.9 e 32 AC-01; ADR-0010; `identity-access-v1` | BL-006, QA-002 | contract artifact `v3`, porte/config/crypto, migration `000004_identity_access` e `packages/persistence/src/identity-access-store.ts` implementati; route API/BFF e pagine `sign-in`, `reset-password`, `account/security` restano target | contract/config/crypto/startup e migration `PASS`; store PostgreSQL 2/2, regressione store 3/3 e security 2/2 provano rate, idle/absolute expiry, rotation, replay, revoca e reset concorrente. Restano service/API/worker/BFF/UI, fixation/cookie, anti-enumeration end-to-end e browser 320/390/1440 | persistence slice TDD verde; runtime HTTP/UI e gate terminali aperti |
