...
Il repository pubblico è versionato e collegato a `Emacore17/dnd-ai`. `BL-001` ha introdotto lo scaffold applicativo, `BL-002` pipeline/Ruleset e `BL-003` config/startup fail-fast. `BL-004`, `BL-005`, `BL-008`, `BL-009`, `BL-010`, `BL-079`, `GOV-002`, `GOV-004`, `QA-001` e `DOC-ARCH-001` sono `DONE/100%/PASSING` e integrati su `main`. BL-005 è verificato tramite PR #28, candidate corretto `c2e4332b408f1cac3e2c69920cd18e5e772e87bf`, merge `e173fd9424ad77330ae8302f68affd4832d66798` e CI PR/post-merge `29525777416`/`29526030389`, entrambe 5/5 `SUCCESS`. `BL-006` è `IN_PROGRESS/25%/PARTIAL` con design `identity-access-v1` approvato e implementazione non iniziata; `BL-081` resta `READY`, `QA-002` `BACKLOG` e `BL-080` congelato/bloccato.
...
| Login, session lifecycle, logout, revoca globale e reset one-time | spec §§20, 22.2, 22.8–22.12, 26.5, 26.8, 26.9 e 32 AC-01; ADR-0010; `identity-access-v1` | BL-006, QA-002 | target contract artifact `v3`, migration `000004_identity_access`, `PostgresIdentityAccessStore`, route API/BFF e pagine `sign-in`, `reset-password`, `account/security` | unit/DB/API/worker/BFF/UI/security; idle/absolute expiry, rotation/fixation, replay/race, anti-enumeration, reset concorrente, redaction e browser 320/390/1440 | design approvato; implementazione/test TDD non iniziati, gate documentale in corso |
