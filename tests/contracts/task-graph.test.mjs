...
test("unknown dependencies and cycles fail the graph", () => {
  ...
  assert.ok(errors.some((error) => error.includes("unknown-dependency: BL-999")));
});
...
test("a UI task must cite the design contract and accepted ADR", () => {
  const markdown = [
    taskCard({
      id: "BL-079",
      references: "`docs/product/UX_UI_DESIGN.md`; `docs/adr/0001-mobile-first-conversational-ui.md`; `docs/MVP_SPEC.md` §31 `BL-079`"
    }),
    taskCard({
      id: "BL-005",
      dependencies: "BL-079",
      references: "`docs/product/UX_UI_DESIGN.md`; `docs/MVP_SPEC.md` §31 `BL-005`"
    }).replace(
      "Fixture\n- **Deliverable:**",
